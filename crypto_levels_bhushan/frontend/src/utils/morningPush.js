/**
 * Morning Nifty 50 Web Push — permission, subscribe, test
 */
...
export function sendLocalTestNotification() {
  ...
  new Notification('Crypto Levels — test', {
    body: 'Local test OK. Next step: subscribe for 8 AM IST Nifty 50 alerts.',
    icon: '/favicon.ico',
    tag: 'morning-test-local',
  });
}
...
export async function subscribeToPush() {
  ...
  localStorage.setItem('morningPushSubscribed', '1');
  return data;
}
