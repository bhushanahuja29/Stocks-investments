...
def record_keepalive_ping(db, *, status: str, message: str) -> datetime:
...
def get_keepalive_status(db) -> dict[str, Any]:
    ...
    row = db.system_settings.find_one({"key": KEEPALIVE_SETTINGS_KEY}) or {}
